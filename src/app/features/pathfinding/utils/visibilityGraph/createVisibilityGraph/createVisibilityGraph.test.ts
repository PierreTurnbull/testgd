...
import { createHitbox } from "@root/app/features/hitbox/utils/createHitbox";
...
import { createWall } from "@root/app/features/wall/utils/createWall";
...
vi.mock("@root/app/features/hitbox/constants/hitboxes.constants", async (importOriginal) => {

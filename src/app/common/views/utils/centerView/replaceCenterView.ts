...
import { initCenterView } from "./initCenterView";
...
export const replaceCenterView = (
	...
	const prevCenterView = centerViewComponent.centerView;

	centerViewComponent.centerView = initCenterView(name, coordinates);

/**
 * Return the distance on x and y in order to travel an euclidian distance.
 * @param movementXRatio
 * @param movementYRatio
 * @returns the distance on x and on y
 */
export function getEuclidianDistance(euclidianDistance: number, movementXRatio: number, movementYRatio: number) {
